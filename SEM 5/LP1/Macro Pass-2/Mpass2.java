...
public class Mpass2 {
	...
	public static void main(String[] args) throws IOException {
		...
		int macro_addr = -1;
	 	...
	 	BufferedReader br1=new BufferedReader(new FileReader("/home/avi/Downloads/LP/MNT.txt"));
	 	String line;
		...
		br1=new BufferedReader(new FileReader("/home/avi/Downloads/LP/argmnt.txt"));
	 	while((line = br1.readLine())!=null)
	 	{
		...
		br1=new BufferedReader(new FileReader("/home/avi/Downloads/LP/MDT.txt"));
	 	while((line = br1.readLine())!=null)
	 	{
	 		MDT[mdt_cnt]=new mdt();
		...
		br1=new BufferedReader(new FileReader("/home/avi/Downloads/LP/input4.txt"));
		arglist[] actual_parameter=new arglist[10];
		
		BufferedWriter bw1 = new BufferedWriter(new FileWriter("/home/avi/Downloads/LP/output4.txt"));
	 	while((line = br1.readLine())!=null)
	 	{
